...
public class EngineFireLeft extends EngineFire {
	static Map<String, List<Frame>> actionFrames = new HashMap<String, List<Frame>>();
	
	public EngineFireLeft(int x, int y, EngineMana mana, Cell cell)  throws ClusteredInitException {
		super(x, y, mana, cell);
	}
	...
	public static void init(CellData cellData) {
		addActions(cellData, FIRE_ACTION, "mana/engine/fire/left", 2, actionFrames);
	}
